...
import literaryMarriageTableArt from "./assets/round-table-literary-marriage-pixel.png";
import timeTravelTableArt from "./assets/round-table-time-travel-pixel.png";
...
type SceneId = "three-kingdoms" | "journey-west" | "literary-marriage" | "time-travel" | "free-travel";
...
const scenes: Record<SceneId, SceneConfig> = {
  ...
  "literary-marriage": {
    ...
    label: "场景三：名著联姻",
    title: "名著联姻",
    art: literaryMarriageTableArt,
    alt: "李逵、林黛玉、孙悟空、关羽在公司会议室围坐圆桌讨论的像素风场景",
    people: [
      {
        id: 1,
        name: "林黛玉",
    ...
    seats: [
      { bubbleX: 50, bubbleY: 24, labelX: 50, labelY: 3 },
      { bubbleX: 20, bubbleY: 50, labelX: 10, labelY: 62 },
      { bubbleX: 80, bubbleY: 50, labelX: 90, labelY: 62 },
      { bubbleX: 50, bubbleY: 83, labelX: 50, labelY: 96 }
    ]
  },
  "time-travel": {
    id: "time-travel",
    label: "场景四：穿越时空",
    title: "穿越时空",
    art: timeTravelTableArt,
    alt: "李逵、林黛玉、阿杰、关羽在公司会议室围坐圆桌讨论的像素风场景",
    people: [
      {
        id: 1,
        name: "林黛玉",
